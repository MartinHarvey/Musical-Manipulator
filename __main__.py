...
#Importing audio file into variable track using AudioSegment function
track = AudioSegment.from_mp3(file_path)

#Loop continues until exit command is given
while loop:
    #Users given choice of commands
    print "You can reverse, check-length, repeat, edit volume, merge tracks, check volume and exit"
